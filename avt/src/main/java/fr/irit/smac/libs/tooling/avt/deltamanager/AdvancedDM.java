 ...
 * <p>
 * Pay caution, some of those methods don't guarantee the DeltaManager state consistency. Generally, you should only use
 * this interface if you have good reasons and you know what you are doing.
 * </p>
 * <p>
 ...
 */
public interface AdvancedDM extends DeltaManager {
	...
	/**
	 * Returns the next delta if it would be adjusted towards the given direction
	 * 
	 * @param direction
	 * @return the next delta if it would be adjusted towards the given direction
	 */
	...
	/**
	 * Returns the number of the geometric step corresponding to the current delta value.
	 * 
	 * @return the number of the geometric step corresponding to the current delta value.
	 */
	 ...
	 * <p>
	 * Setting this step number will change the value of delta, in order to keep consistency between these two values.
	 * </p>
	 * 
	 ...
	 * </p>
	 * <p>
	 * Only call this method for tweeky initialisation purpose and if you know what you do.
	 * </p>
	 * If you want to change the deltaMin value and be sure delta max is reconfigured from the delta min value and the
	 * range of the AVT call the <strong>reconfigure(...)</strong> method.
	 * 
	 * @param deltaMin
	 *            the deltaMin to set
	 ...
	 * 
	 * <strong>STATE CONSISTENCY WARNING:</strong> this method will ignore the real range of the AVT (eg. size of its
	 * search space).
	 * 
	 * @param deltaMin
	 *            minimal delta value (or tuning step)
	 * @param range
	 *            the size of the search space the deltaManager is supposed to evolve in.
	 */
