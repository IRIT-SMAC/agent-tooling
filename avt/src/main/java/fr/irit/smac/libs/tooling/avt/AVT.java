 ...
 * <li>AVT value can be adjusted by the method <code>adjustValue(feedback)</code> where the feedback informs whether the
 * value must be incremented of decremented</li>
 * </ul>
 * <p>
 * You should use an instance of the <code>AVTBuilder</code> to easily get a well initialized AVT. For example :
 * </p>
 * <p>
...
public interface AVT {
	 ...
	 *  <li><code>Feedback.GOOD</code>: decreases the criticity of the AVT but doesn't change the value. This feedbacks
	 * express that the current value is good and should evolve more slowly at the next adjustment.</li>
	 * </ul>
	 * 
	 * 
	 * @param feedback
	 ...
	 * <p>
	 * Criticity is a value that express the estimated inaccuracy of the current value. The criticity is a value between
	 * 0 and 1 where :
	 * </p>
	 * <ul>
	 ...
	 * <p>
	 * Pay caution, some of the methods of this interface doesn't guarantee the AVT state consistency. Generally, you
	 * should only uses this interface if you have good reasons and you know what you are doing.
	 * </p>
	 * 
