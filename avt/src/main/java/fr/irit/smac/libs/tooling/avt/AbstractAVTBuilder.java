 ...
 */
public abstract class AbstractAVTBuilder<AVTType extends AVT> implements IAVTBuilder<AVTType> {
	...
	protected AVTFactory<AVTType> avtFactory = null;;

	// Delta Parameters
	protected DeltaManagerFactory<?> deltaManagerFactory = null;
	 ...
	 */
	@Override
	public AbstractAVTBuilder<AVTType> isHardBounds(boolean isHardBounds) {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see fr.irit.smac.util.avt.IAVTBuilder#avtFactory(fr.irit.smac.util.avt.AVTFactory)
	 */
	@Override
	public AbstractAVTBuilder<AVTType> avtFactory(AVTFactory<AVTType> avtFactory) {
	 ...
	 */
	@Override
	public AbstractAVTBuilder<AVTType> softBoundsMemory(int softBoundsMemory) {
	 ...
	 */
	@Override
	public AbstractAVTBuilder<AVTType> isDelayedDelta(boolean isDelayed) {
	 ...
	 */
	@Override
	public AbstractAVTBuilder<AVTType> isBoundedDelta(boolean isBounded) {
	 ...
	 */
	@Override
	public AbstractAVTBuilder<AVTType> isDeterministicDelta(boolean isDeterministic) {
	 ...
	 */
	@Override
	public AbstractAVTBuilder<AVTType> deltaIncreaseFactor(double increaseFactor) {
		if (increaseFactor < 1.) {
	 ...
	 */
	@Override
	public AbstractAVTBuilder<AVTType> deltaDecreaseFactor(double decreaseFactor) {
		if (decreaseFactor < 1.) {
	 ...
	 */
	@Override
	public AbstractAVTBuilder<AVTType> deltaDecreaseNoise(double decreaseNoise) {
	 ...
	 */
	@Override
	public AbstractAVTBuilder<AVTType> deltaRandomSeed(long seed) {
	 ...
	 */
	@Override
	public AbstractAVTBuilder<AVTType> deltaIncreaseDelay(int increaseDelay) {
		if (increaseDelay < 0) {
	 ...
	 */
	@Override
	public AbstractAVTBuilder<AVTType> deltaDecreaseDelay(int decreaseDelay) {
		if (decreaseDelay < 0) {
	 ...
	 */
	@Override
	public AbstractAVTBuilder<AVTType> deltaMin(double deltaMin) {
	 ...
	 */
	@Override
	public AbstractAVTBuilder<AVTType> deltaMax(double deltaMax) {
	 ...
	 */
	@Override
	public AbstractAVTBuilder<AVTType> lowerBound(double lowerBound) {
	 ...
	 */
	@Override
	public AbstractAVTBuilder<AVTType> upperBound(double upperBound) {
	 ...
	 */
	@Override
	public AbstractAVTBuilder<AVTType> startValue(double startValue) {
	 ...
	 * 
	 * @see
	 * fr.irit.smac.util.avt.IAVTBuilder#deltaManagerFactory(fr.irit.smac.util.avt.deltamanager.DeltaManagerFactory)
	 */
	@Override
	public AbstractAVTBuilder<AVTType> deltaManagerFactory(DeltaManagerFactory<?> deltaManagerFactory) {
	...
	/**
	 * throws a lot of exceptions, that are described in the doc of the build() function
	 */
	...
	public AVTType build() {
		...
		if (this.deltaManagerFactory == null) {
			...
			GeometricDEFactory deltaEvolutionFactory = null;
			...
			DMDecisionFactory dmDecisionFactory = new StandardDMDFactory();
